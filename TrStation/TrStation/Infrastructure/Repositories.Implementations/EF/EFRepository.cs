...
using TrainStation.Domain.TrainStation.Domain.Repositories.Abstractions;
using TrStation.Domain.TrainStation.Domain.Entities.Base;

namespace TrainStation.Infrastructure.Repositories.Implementations.EF
{
    ...
    {
        /* public virtual async Task<IEquatable<TEntity?>> GetAllAsync(CancellationToken cancellationToken, bool asNoTracking = false)
